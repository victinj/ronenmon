...
function MonsterScreen({ player, navigateTo }) {
        ...
        <div className='relative h-3/4'>
          <div className='h-full'>
            <div className='relative w-full h-full flex'>
              <div className='w-full bg-monster-bg-box
  ...
  return (
    <div
      id="monster-screen"
      className="flex p-5 bg-transparent"
    >
      ...
      {/* Monster Selection */}
      <div className='relative bg-black w-[500px]'>
        <div className='bg-monster-bg-box size-10
                        border-[6px] border-tv-border rounded-3xl 
                        p-6 shadow-lg'>
        </div>
      </div>
      {/* <div className='absolute right-[50px] top-[130px] flex items-center'> */}
      {/*   <div className='w-[750px] h-[480px] bg-monster-bg-box  */}
      {/*                   border-[6px] border-tv-border rounded-3xl  */}
