    ...
    <div className="game-screen active">
      ...
      <div className='flex h-full justify-center items-center'>
        <div className='grid grid-rows-8 w-1/4 h-[70%] gap-50px'>
          <div className='grid grid-rows-4 bg-play-inner-bg row-span-4 
            ...
            <div className='grid grid-cols-2  row-span-2'>
              <button className='bg-green-button m-5 mt-10 mb-10 border-black text-2xl border-[3px] rounded-[20px] shadow-button-default'><h2>Deposit</h2></button>
              <button className='bg-red-button m-5 mt-10 mb-10 border-black text-2xl border-[3px] rounded-[20px] shadow-button-default'>Withdraw</button>
            </div>
          </div>
